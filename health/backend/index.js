...
// Register patient endpoint with IPFS upload
app.post('/api/register/patient', upload.single('medicalRecord'), async (req, res) => {
    ...
    try {
        ...
        const [userRes] = await conn.execute(
            `INSERT INTO users (wallet_address, user_type, full_name, email, phone, gender, date_of_birth)
       VALUES (?, 'patient', ?, ?, ?, ?, ?)`,
        ...
        await conn.execute(
            `INSERT INTO patients (user_id, address, blood_group, medical_history, medical_record_file)
       VALUES (?, ?, ?, ?, ?)`,
            [userId, address || null, bloodGroup || null, medicalHistory || null, ipfsHash]
        );
...
app.post('/api/register/doctor', async (req, res) => {
    ...
    try {
       ...
       VALUES (?, 'doctor', ?, ?, ?, ?, ?)`,
        ...
        await conn.execute(
            `INSERT INTO doctors (user_id, medical_id, specialization, qualification, hospital_name)
       VALUES (?, ?, ?, ?, ?)`,
